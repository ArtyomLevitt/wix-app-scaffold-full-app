export const APP_ID = 'a1b2c3d4-e5f6-7890-abcd-ef1234567890';
export const APP_SLUG = 'pdf-viewer';
export const APP_NAME = 'PDF Viewer & Flipbook';
export const APP_NS = '@prpl/pdf-viewer';
...
export const LS_LAST_SAVED = `${APP_SLUG}_last_saved_at`;
