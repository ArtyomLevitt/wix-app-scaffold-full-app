...
- [ ] **Supabase client** at `src/extensions/_shared/supabase-client.ts`, **gitignored** before first commit.
...
- [ ] Verified `git check-ignore -v src/extensions/_shared/supabase-client.ts` returns the gitignore rule.
...
| Commit `src/extensions/_shared/supabase-client.ts` | Add to `.gitignore` BEFORE first commit |
